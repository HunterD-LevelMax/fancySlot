...
class FancySoundManager(context: Context) {
    ...
    private val getMoneySound = soundPool.load(appContext, R.raw.get_money_2, 1)
    private val selectValueSound = soundPool.load(appContext, R.raw.select_value, 1)

    private var musicPlayer: MediaPlayer? = MediaPlayer.create(appContext, R.raw.music)?.apply {
        isLooping = true
